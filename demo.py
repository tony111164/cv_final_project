...
def get_args_parser():
    ...
    parser.add_argument('--ckpt_path', type=str, default='./checkpoints/spann3r_101.pth', help='ckpt path')
    ...
    parser.add_argument('--kf_every', type=int, default=20, help='map every kf_every frames')
...
def main(args):
    ...
    o3d.io.write_point_cloud(os.path.join(save_demo_path, f"{demo_name}.ply"), pcd)
    ...
    if args.save_ori:
        ...
        transform_dict = get_transform_json(H, W, focal, poses_all, f"{demo_name}.ply")
