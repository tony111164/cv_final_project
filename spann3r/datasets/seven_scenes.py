...
class SevenScenes(BaseManyViewDataset):
    ...
    def load_all_scenes(self, base_dir):
        ...
        if self.tuple_list is not None:
            ...
            self.scene_list = ['chess/train/seq-01','chess/train/seq-02','chess/train/seq-04','chess/train/seq-06',
                                'fire/train/seq-01','fire/train/seq-02',
                                'heads/train/seq-02',
                                'office/train/seq-01','office/train/seq-03','office/train/seq-04','office/train/seq-05','office/train/seq-08','office/train/seq-10',
                                'pumpkin/train/seq-02','pumpkin/train/seq-03','pumpkin/train/seq-06','pumpkin/train/seq-08',
                                'redkitchen/train/seq-01','redkitchen/train/seq-02','redkitchen/train/seq-05','redkitchen/train/seq-07','redkitchen/train/seq-08','redkitchen/train/seq-11','redkitchen/train/seq-13',
                               ]
            ...
            with open(osp.join(base_dir, scene, file_split)) as f:
                ...
                for seq_id in seq_ids:
                    ...
                    if self.seq_id is not None and seq_id != self.seq_id:
                        continue
                    self.scene_list.append(f"{scene}/{self.split}/{seq_id}")
